...
static void parseData()
{
    switch(buffer[3]){
        ...
        case 3: lcd.setCursor(getByte(0),getByte(1));; callOK(); break;
        case 5: pinMode(13,OUTPUT);digitalWrite(13,getByte(0));; callOK(); break;
        ...
        case 10: sendShort((pinMode(A0+getByte(0),INPUT),analogRead(A0+getByte(0)))); break;
