...
static void parseData()
{
    ...
    switch(buffer[3]){
        case 1: pinMode(P_LED,OUTPUT);digitalWrite(P_LED,getByte(0));; callOK(); break;
        case 2: sendShort((_getSpeed(getByte(0)))); break;
        case 3: _setServo(getByte(0),getShort(1),1);; callOK(); break;
