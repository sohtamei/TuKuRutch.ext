(function(ext) {
	...
	ext.dump0P = function(id,pwm,speed,T){
		trace("dump0P:" + id + "," + pwm + "," + speed + "," + T);
		responseValue();
	}

	ext.dump0M = function(id,pwm,speed,T){
		trace("dump0M:" + id + "," + pwm + "," + speed + "," + T);
		responseValue();
	}

	ext.dump1P = function(id,pwm,speed,T){
		trace("dump1P:" + id + "," + pwm + "," + speed + "," + T);
		responseValue();
	}

	ext.dump1M = function(id,pwm,speed,T){
		trace("dump1M:" + id + "," + pwm + "," + speed + "," + T);
		responseValue();
	}
