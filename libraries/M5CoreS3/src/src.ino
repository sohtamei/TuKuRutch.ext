...
void _drawJpg(uint8_t* buf, int size) {
	...
	int x = GetL16(buf+0);
	int y = GetL16(buf+2);
	M5.Display.drawJpg(buf+4, size-4, x, y);
}
...
static void parseData()
{
  ...
  switch(cmd){
case 1: sendBin(buffer, _getConfig(buffer)); break;
case 2: sendBin(buffer, getIMUs(getByte(0),buffer)); break;
case 4: __tone(getShort(0),getShort(1));; callOK(); break;
case 5: __tone(1000,100);; callOK(); break;
case 6: M5.Speaker.setVolume(getByte(0));; callOK(); break;
case 7: sendByte((_getSw(getByte(0)))); break;
case 8: M5.Power.setLed(getByte(0)?255:0);; callOK(); break;
case 10: M5.Display.setFont(lgfx::v1::fontdata[getByte(0)]);; callOK(); break;
case 11: M5.Display.setRotation(getByte(0));; callOK(); break;
case 12: M5.Display.setTextColor(getShort(0),getShort(1));M5.Display.setTextSize(getFloat(2));; callOK(); break;
case 13: M5.Display.setCursor(getShort(0),getShort(1));; callOK(); break;
case 14: M5.Display.print(getString(0));; callOK(); break;
case 15: M5.Display.println(getString(0));; callOK(); break;
case 16: M5.Display.drawString(getString(0),getShort(1),getShort(2));; callOK(); break;
case 17: M5.Display.drawString(getString(0),getShort(1),getShort(2),lgfx::v1::fontdata[getByte(3)]);; callOK(); break;
case 18: M5.Display.fillScreen(getShort(0)); M5.Display.setCursor(0,0);; callOK(); break;
case 19: _drawJpg(getBufLen2(0));; callOK(); break;
case 20: M5.Display.setBrightness(getByte(0));; callOK(); break;
case 21: M5.Speaker.playRaw(getBufLen2(0), 44100, false);; callOK(); break;
