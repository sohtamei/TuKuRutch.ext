...
static void parseData()
{
      ...
      switch(cmd){
        case 1: _displayText(getString(0));; callOK(); break;
        case 2: _displayLed(getLong(0));; callOK(); break;
        case 3: _getSendData(); break;
        case 4: sendShort((_getTilt(getByte(0)))); break;
        case 5: _RadioEnable(getByte(0),getByte(1),getByte(2));; callOK(); break;
        case 6: _RadioSend(getBufLen(0));; callOK(); break;
        case 7: _RadioRecv(); break;
