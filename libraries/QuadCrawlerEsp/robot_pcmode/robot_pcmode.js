...
/**
 * Class for the DummyName block in Scratch 3.0.
 * @constructor
 */
class Scratch3DummyNameBlocks {
    constructor (runtime) {
        /**
...
{blockType: BlockType.COMMAND, opcode: 'setWalk', text: {
    ...
    ARG2: { type: ArgumentType.NUMBER, type2:'S', defaultValue:200, menu: 'speed' },
}},
...
{ text: {
    'en': 'all_down',
    'ja': '伸び',
}[this._locale], value: 8 },
{ text: {
    'en': 't_down',
    'ja': '後傾斜',
}[this._locale], value: 9 },
{ text: {
    'en': 'h_down',
    'ja': '前傾斜',
}[this._locale], value: 10 },
{ text: {
    'en': 'l_down',
    'ja': '左傾斜',
}[this._locale], value: 11 },
{ text: {
    'en': 'r_down',
    'ja': '右傾斜',
}[this._locale], value: 12 },
{ text: {
    'en': 't_up_down',
    'ja': '背伸び',
}[this._locale], value: 13 },
{ text: {
    'en': 'l_r_up',
    'ja': '左右傾斜',
}[this._locale], value: 14 },
{ text: {
    'en': 'all_up_down',
    'ja': 'スクワット',
...
module.exports = Scratch3DummyNameBlocks;
