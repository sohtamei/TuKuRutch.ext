...
static void parseData()
{
      ...
      switch(cmd){
        case 1: _setReg(getLong(0),getLong(1));; callOK(); break;
        case 2: sendString((_getReg(getLong(0)))); break;
        case 3: _setLedc(getLong(0));; callOK(); break;
